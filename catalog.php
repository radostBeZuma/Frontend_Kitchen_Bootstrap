...
<section class="catalog py-10">
    <div class="container">
        <div class="row pb-9 align-items-center">
            <div class="col-12 col-md-6 col-lg-5">
                <h1 class="catalog__title fw-black fs-9 fs-md-4 fs-lg-3 pb-5">Каталог товаров</h1>
                <p class="catalog__desc pb-7 pb-md-0 mb-0">Отображаются все <span>37</span> результатов</p>
            </div>
            <div class="col-12 col-md-6 offset-lg-3 col-lg-4 offset-xl-4 col-xl-3">
                <div class="dropdown">
                    <button class="btn btn-wild-sand dropdown-toggle w-100 text-start d-flex justify-content-between align-items-center fw-medium py-2"
                            type="button"
                    ...
                    <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuKitchen">
                        ...
                        <li><button class="dropdown-item" type="button">по алфавиту в обратном порядке</button></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row pb-7">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 pb-6 pb-sm-4 d-sm-flex align-items-sm-stretch">
                <div class="card rounded-0">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        <a class="card-title fw-semibold d-block pb-4 text-decoration-none text-decoration-none mb-0 text-decoration-none" href="#">Кухонный гарнитур “ЛОФТ”. Длина 2 метра.</a>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 pb-6 pb-sm-4 d-sm-flex align-items-sm-stretch">
                <div class="card rounded-0">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        <a class="card-title fw-semibold d-block pb-4 text-decoration-none" href="#">Кухонный гарнитур с фотопечатью “Орхидея”. Длина 2 метра.</a>
                        <div class="popular-models__card-price-n-btn d-flex justify-content-between align-items-end">
                            <div class="popular-models__card-price">
                                <div class="popular-models__card-old-price fw-semibold text-silver-chalice text-decoration-line-through">19 899</div>
                                <div class="popular-models__card-now-price fw-semibold text-secondary fs-4">14 900</div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 pb-6 pb-sm-4 d-sm-flex align-items-sm-stretch">
                <div class="card rounded-0">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        <a class="card-title fw-semibold d-block pb-4 text-decoration-none" href="#">Кухонный гарнитур “ЛОФТ”. Длина 2 метра.</a>
                        <div class="popular-models__card-price-n-btn d-flex justify-content-between align-items-end">
                            <div class="popular-models__card-price">
                                <div class="popular-models__card-old-price fw-semibold text-silver-chalice text-decoration-line-through">19 899</div>
                                <div class="popular-models__card-now-price fw-semibold text-secondary fs-4">14 900</div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 pb-6 pb-sm-4 d-sm-flex align-items-sm-stretch">
                <div class="card rounded-0">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        <a class="card-title fw-semibold d-block pb-4 text-decoration-none" href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis ex laborum optio quis reprehenderit.</a>
                        <div class="popular-models__card-price-n-btn d-flex justify-content-between align-items-end">
                            <div class="popular-models__card-price">
                                <div class="popular-models__card-old-price fw-semibold text-silver-chalice text-decoration-line-through">19 899</div>
                                <div class="popular-models__card-now-price fw-semibold text-secondary fs-4">14 900</div>
        ...
        <div class="row">
            <div class="offset-0 offset-sm-2 offset-md-3 offset-lg-4 col-12 col-sm-8 col-md-6 col-lg-4">
                <a class="btn btn-primary w-100 py-3 fs-6 fs-sm-5" href="#">Показать еще</a>
            </div>
        </div>
    </div>
</section>
