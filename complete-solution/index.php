                ...
                <div class="collapse navbar-collapse col-sm-12 col-xl-8 ps-lg-3 ps-xl-0 order-md-4 order-xl-0" id="navbarSupportedContent">
                    <div class="header-navbar__nav-item js-header-nav-item d-flex d-xl-block flex-column justify-content-around bg-white">
                        <ul class="navbar-nav pt-8 pt-xl-0 align-items-center align-items-xl-baseline">
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7" href="/catalog/">Каталог товаров</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7" href="/kitchen-modules/">Кухонные модули</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7" href="/decors/">Декоры</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7" href="/photoprint/">Фотопечать</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7 active" href="/complete-solution/">Готовые решения</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-8 fs-xl-7 disabled" href="#">Контакты</a>
                            </li>
                        </ul>
                        <div class="container">
                            <div class="row">
